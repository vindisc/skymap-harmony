...
[
  ...
  '.height(30)',
  '.borderRadius(12)',
  "const CARD_PRIMARY_SOFT: string = '#D0E8DB';",
  "const CARD_HINT_BACKGROUND: string = '#F1EADF';",
...
[
  ...
  "Text('已完成')",
  "const SUMMARY_CARD_PRIMARY_SOFT: string = '#DDEFE6';",
  "const SUMMARY_CARD_PROGRESS_SOFT: string = '#EEF5EF';",
  "const SUMMARY_CARD_HINT_SOFT: string = '#F2F6F1';",
  'Column({ space: 7 })',
  '.layoutWeight(55)',
  '.layoutWeight(45)',
  '.height(68)',
  ...
  "Text('›')",
  '.height(24)',
  '.backgroundColor(SUMMARY_CARD_HINT_SOFT)',
